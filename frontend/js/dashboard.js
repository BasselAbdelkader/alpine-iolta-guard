    ...
    if (staleClients.length === 0) {
        ...
        staleClientsTable.innerHTML = staleClients.map(client => `
            <tr>
                ...
                <td class="text-success">${formatCurrency(client.balance)}</td>
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group btn-group-sm" role="group">
                        ...
                        <button class="btn btn-outline-info btn-sm" onclick="viewAuditTrail(${check.id}, '${check.check_number}')" title="Audit Trail">
