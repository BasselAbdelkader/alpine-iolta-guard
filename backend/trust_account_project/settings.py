...
MIDDLEWARE = [
    ...
    # 'trust_account_project.threat_detection.AdvancedThreatDetectionMiddleware',  # Temporarily disabled
    'trust_account_project.security.BruteForceProtectionMiddleware',
    # 'trust_account_project.api_hardening.APISecurityMiddleware',  # Temporarily disabled
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsrfViewMiddleware',
    # 'trust_account_project.csrf_protection.AdvancedCSRFProtectionMiddleware',  # Temporarily disabled
