...
class VendorDetailView(LoginRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        for transaction in payment_items:
            # Vendor payments are typically withdrawals from trust account
        ...
        payment_stats = payment_items.filter(
        ...
        client_payments = {}
        for transaction in payment_items:
            if transaction.client and transaction.transaction_type in ['WITHDRAWAL', 'TRANSFER_OUT']:
